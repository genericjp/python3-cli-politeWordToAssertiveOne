...
class CnvTone():
    ...
    def __init__(self):
        ...
        self.dct_wgrp1 = {
                ...
                'つぐ':       {'語幹': ['つ', '次', '告', '注', '継', '接'], '語変': 'ぎ', '変化': '変化-ぐ,ごう,がった,がx,がx'},
                ...
                'しており':   {'語幹': ['して'], '語変': 'おり', '変化': '変化-いる,いるだろう,いた,いなかった,いない'},
        ...
        self.dct_wchg = {
                ...
                # e.g.　しております
                '変化-いる,いるだろう,いた,いなかった,いない':
                        {'ます': 'いる',  'ましょう': 'いるだろう',    'ました': 'いた',  'ませんでした': 'いなかった',  'ません': 'いない'},
