...
class CnvTone():
    ...
    def __init__(self):
        ...
        self.dct_wgrp = {
                ...
                '参照する': {'語幹': ['参照'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                '指示する': {'語幹': ['指示'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                '使用する': {'語幹': ['使用'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                '注意する': {'語幹': ['注意'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                '提示する': {'語幹': ['提示'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                '表示する': {'語幹': ['表示'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                '利用する': {'語幹': ['利用'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                '表現する': {'語幹': ['表現'], '語変': 'し', '変化': '変化-する,のこと,した,しx,しx'},
                ...
                'つづく':     {'語幹': ['つづく', '続'], '語変': 'き', '変化': '変化-く,こう,いた,かx,かx'},
                ...
                '来る':       {'語幹': ['く', '来'], '語変': '', '変化': '変化-来る,来よう,来た,来なかった,来ない', '変語幹':'有'},
        ...
        self.dct_wchg = {
                ...
                # 
                '変化-する,のこと,した,しx,しx': 
                        {'ます': 'する', 'ましょう': 'のこと', 'ました': 'した', 'ませんでした': 'しなかった', 'ません': 'しない'},
                '変化-する,する,した,しx,しx': 
